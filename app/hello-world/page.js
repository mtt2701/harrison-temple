...
export default async function Page() {
    return (
        <Container>
            ...
            <div className="mx-auto max-w-prose space-y-8 py-8 ">
                <article className="prose md:prose-xl prose-primary mx-auto text-center px-8 text-black dark:text-white">
                    Designed by <Link href="https://github.com/mtt2701/harrison-temple">mtt2701</Link>
                </article>
                <article className="prose md:prose-xl prose-primary mx-auto text-center px-8 text-black dark:text-white">
                    Quotes and images from <Link href="https://twitch.tv/vedal987">Vedal987</Link> and <Link href="https://www.youtube.com/@_neurosama">Neuro-sama</Link>
                </article>
            </div>
        </Container>
    )
